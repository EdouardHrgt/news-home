  ...
  <div>
    <header @wheel.prevent @touchmove.prevent @scroll.prevent>
      <nav class="flex-align">
        ...
        <button class="mobile-icons active">
          <svg
            class="active"
            width="40"
            height="17"
          ...
          <svg class="active" width="32" height="31" xmlns="http://www.w3.org/2000/svg" @click="isOpen = !isOpen" v-show="isOpen">
            <g fill="#00001A" fill-rule="evenodd">
        ...
        <ul class="flex" :class="{ activeMenu: isOpen, reverse: !isOpen }">
          <li>
            <p>Home</p>
          </li>
          <li>
...
@media screen and (max-width: 768px) {
  ...
  .filterOn {
    ...
    animation: opak 0.9s ease-in-out 0.3s forwards;
  }
  .filterOff {
    animation: filter-off 1s 0.7s forwards;
  }
  .reverse {
